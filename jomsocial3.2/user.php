		...
		foreach ($notifications as $key => $value)
		{
			...
			switch ($value->cmd_type)
			{
				...
				case "notif_videos_like":
					...
					$videoTitle                                                       = $params->get('video');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{video}', $videoTitle, $value->content));
				...
				case "notif_profile_activity_add_comment":
					$usr                                                              = $this->jomHelper->getUserDetail($value->actor);
					$params                                                           = new CParameter($value->params);
					$streamTitle                                                      = $params->get('stream');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{stream}', $streamTitle, $value->content));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'stream';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
					$this->jsonarray['notifications']['global'][$ind]['user_profile'] = $usr->profile;
				...
				case "notif_inbox_create_message":
					...
					$params                                                           = new CParameter($value->params);
					$msg                                                              = $params->get('msg');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{msg}', $msg, $value->content));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'messages';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
					$this->jsonarray['notifications']['global'][$ind]['user_profile'] = $usr->profile;
				...
				case "notif_photos_like":
					...
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{photo}', $photoTitle, str_replace('{album}', $albumTitle, $value->content)));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'photos';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
					$this->jsonarray['notifications']['global'][$ind]['user_profile'] = $usr->profile;
				...
				case "notif_groups_wall_create":
					$usr                                                              = $this->jomHelper->getUserDetail($value->actor);
					$params                                                           = new CParameter($value->params);
					$groupTitle                                                       = $params->get('group');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{group}', $groupTitle, $value->content));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'groups';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
				...
				case "notif_groups_create_news":
					$usr                                                              = $this->jomHelper->getUserDetail($value->actor);
					$params                                                           = new CParameter($value->params);
					$groupTitle                                                       = $params->get('group');
					$announcementTitle                                                = $params->get('announcement');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{announcement}', $announcementTitle, str_replace('{group}', $groupTitle, $value->content));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'groups';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
				...
				case "notif_groups_discussion_reply":
					$usr                                                              = $this->jomHelper->getUserDetail($value->actor);
					$params                                                           = new CParameter($value->params);
					$discussionTitle                                                  = $params->get('discussion');
					$this->jsonarray['notifications']['global'][$ind]['notif_title']  = str_replace('{actor}', $usr->name, str_replace('{discussion}', $discussionTitle, $value->content));
					$this->jsonarray['notifications']['global'][$ind]['type']         = 'groups';
					$this->jsonarray['notifications']['global'][$ind]['user_id']      = $usr->id;
					$this->jsonarray['notifications']['global'][$ind]['user_name']    = $usr->name;
					$this->jsonarray['notifications']['global'][$ind]['user_avatar']  = $usr->avatar;
