...
class group
{
	...
	function addAnnouncement()
	{
		...
		if (!$announcementID)
		{
			...
			$params->set('group_url', 'index.php?option=com_community&view=groups&task=viewgroup&groupid=' . $uniqueID);
			$params->set('subject', $bulletin->title);
			$params->set('announcement', $bulletin->title);
			$params->set('announcement_url', 'index.php?option=com_community&view=groups&task=viewbulletin&groupid=' . $uniqueID . '&bulletinid=' . $bulletin->id);
