	...
	<table style="text-align: left;" class="paramlist admintable">
		...
		<tr>
			...
			<td style="width: 100px">SobiPro Sections<br/>
				<select name="section_list1" id="section_list1" class="inputbox" multiple="multiple"
			...
			<td style="width: 100px">Sections To Show<br/>
				<select name="sobipro_Section_List[]" id="section_list2" class="inputbox" multiple="multiple"
				        style="width: 180px;height:120px">
			...
			<td valign="bottom">
				<p>
					<b style="color:#0B55C4">(Note : Please hit apply button to see the appropriate sections and
						category listing in latitude/longitude settings & Featured listing)</b>
				</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="sobipro_MAP_API_KEY" id="sobipro_MAP_API_KEY"
				       value="<?php echo $this->cfg["sobipro_MAP_API_KEY"]; ?>"/>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<select name="sobipro_Radius_Search_Unit" id="sobipro_Radius_Search_Unit">
					<option
						value="km" <?php echo ($this->cfg["sobipro_Radius_Search_Unit"] == 'km') ? 'selected="selected"' : ''; ?>>
						KM
					</option>
					<option
						value="mile" <?php echo ($this->cfg["sobipro_Radius_Search_Unit"] == 'mile') ? 'selected="selected"' : ''; ?>>
						Mile
					</option>
				</select>
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" name="sobipro_Max_Search" id="sobipro_Max_Search"
				       value="<?php echo $this->cfg["sobipro_Max_Search"]; ?>"/>
			</td>
		</tr>
	</table>
</fieldset>
	...
	<table style="text-align: left;" class="paramlist admintable">
		...
		<tr>
			...
			<td style="width: 100px">SobiPro Entries<br/>
				<select name="product_list1" id="product_list1" class="inputbox" multiple="multiple"
			...
			<td style="width: 100px">Featured For iJoomer<br/>
				<select name="sobipro_Featured_List[]" id="product_list2" class="inputbox" multiple="multiple"
				        style="width: 180px;height:220px">
