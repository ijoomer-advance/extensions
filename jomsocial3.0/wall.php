...
class Wall
{
			...
			else
			{
				...
				switch ($html->app)
				{
					...
					case 'cover.upload':
						...
						$this->jsonarray['update'][$inc]['image_data']['url'] = $params->get('attachment');
						$actor                                                = CFactory::getUser($html->actor);
						$srch                                                 = array('{actor}', "&#9658;", "&quot;");
						$rplc                                                 = array($actor->getDisplayName(), "►", "\"");
						$this->jsonarray['update'][$inc]['titletag']          = str_replace($srch, $rplc, strip_tags($titletag));
	 ...
	 *
	 * @param   integer  $id     id
	 * @param   boolean  $onApp  [description]
	 *
	...
	/**
	 * removeComment funtion
	 *
	 * @param   integer  $wallid  [description]
	 *
	 * @return  boolean           void
	 */
	...
	public function like()
	{
		...
		if ($this->jsonarray = $this->jomHelper->Like($type, $wallID))
		{
			$this->jsonarray['code'] = 200;
