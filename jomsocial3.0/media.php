...
class media
{
	...
	/**
	 * _deleteVideosFiles function
	 *
	 * @param   [type]  $video  videos
	 *
	 * @return  boolean          void
	 */
	 ...
	 * @param   [type]  $deletedvideoid  [description]
	 *
	 * @return  boolean                   void
	 */
	 ...
	 *
	 * @param   integer  $id           id
	 * @param   boolean  $returnThumb  retuns thumb
	 *
	 * @return  boolean                 void
	 */
	 ...
	 *
	 * @param   [type]  $imageFile   image file
	 * @param   [type]  $photoTable  photo Table
	 * @param   [type]  $storedPath  stored Path
	 * @param   [type]  $thumbPath   thumb Path
	 *
	 * @return  boolean               void
	 */
